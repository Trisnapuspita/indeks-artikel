...
<main style="background: white; padding: 45px">
        ...
        <div class="mr-auto" style="padding-bottom:10px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="sumber.html">@foreach ($editions->title()->get() as $title ) {{$title->title}} @endforeach</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{$editions->edition_title}}</li>
            </ol>
        </div>
