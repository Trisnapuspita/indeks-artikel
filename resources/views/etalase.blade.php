    ...
    <main>
        ...
        <div class="etalase-grid">
            <div class="section1">
                <!-- 286x180 -->
                <div class="card">
                    <img class="card-img-top" src="../assets/download.svg" alt="">
                    <div class="card-body">
                        <a class="card-title1" href="etalase-sumber.html">Judul Sumber</a>
                        <br>
                        <a class="card-text" href="etalase-sumber.html">Tahun 2019
                        </a>
                        <br>
                        <br>
                        <br>
                        <br>
                        <a href="etalase-sumber.html">(100 Artikel)</a>
