...
@section('title')
Indeks Artikel | Edit Master Status Ketersediaan
@endsection
...
<main>
    ...
    @endif
        ...
        box-shadow: 0px 0px 17px -4px rgba(0,0,0,0.75);">
            <form class="form" method="POST" action="/statuses/{{$status->id}}">
                <h4 style="font-weight: bold; padding-bottom:10px; text-align:center;color: black">
                    ...
                    <div class="form-group row was-validated">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Nama*</label>
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control" value="{{old('title') ? old('title') :$status->title}}" required>
                            </div>
