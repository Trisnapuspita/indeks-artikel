    ...
    <menu>
        ...
        <div class="mr-auto" style="padding-top: 30px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="Master-Jenis.html">Setting Master</a></li>
		...
		<div class="container mb-5 mt-3">
                    <div class="col-lg-10">
                        <a class="btn btn-dark" href="/statuses/create">Tambah</a>
            ...
            <table class="table table-striped table-bordered" id="mydatatable">
				...
				@foreach ($statuses as $status)
                    <tr>
                        ...
                        <td><a href="">11</a></td>
                        <td> <div>
                            <a class="btn btn-dark" href='/statuses/{{$status->id}}/edit'>Sunting</a>
