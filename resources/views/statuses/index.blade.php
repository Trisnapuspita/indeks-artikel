       ...
       <div id="left" >
        ...
        <div id="content">
            ...
            <div class="inner">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href='/statuses/create' class="btn btn-primary btn-lg">Tambah</a>
                    </div>
                </div>
                <br>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    @foreach ($statuses as $status)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                            @if($status->isOwner())
                                                <a href='/statuses/{{$status->id}}/edit' class="btn btn-primary">Sunting</a>
                                                <a href='/statuses' class="btn btn-danger">Hapus</a>
                                                </form>
                                            @endif
                                            </td>
                                        </tr>
