...
<main style="background: white; padding:45px">
        <div class="mr-auto" style="padding-bottom:10px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/statuses">Master Status Ketersediaan</a></li>
            </ol>
        </div>
        ...
        <table class="Grid" cellspacing="0" cellpadding="4" id="ContentPlaceHolder1_dgData"
			...
			@foreach ($statuses as $status)
                <tr class="GridItem">
                    <td style="width:20px; text-align: center">{{$status->id}}</td>
                    <td style="width:80px; text-align: center"><a href="">{{$status->title}}</a></td>
                    <td style="width:50px;text-align: center">....</td>
					<td style="width:50px;text-align: center"> <div>
                            <a href='/statuses/{{$status->id}}/edit'><button>Sunting</button></a>
