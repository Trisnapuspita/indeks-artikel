...
<main style="background: white; padding:45px">
        <div class="mr-auto" style="padding-bottom:10px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/times">Master Jenis</a></li>
            </ol>
        </div>
        ...
        <table class="Grid" cellspacing="0" cellpadding="4" id="ContentPlaceHolder1_dgData"
			...
			@foreach ($times as $time)
                <tr class="GridItem">
                    <td style="width:20px; text-align: center">{{$time->id}}</td>
                    <td style="width:80px; text-align: center"><a href="">{{$time->title}}</a></td>
                    <td style="width:50px;text-align: center">....</td>
					<td style="width:50px;text-align: center"> <div>
                            <a href='/times/{{$time->id}}/edit'><button>Sunting</button></a>
