    ...
    <menu>
        ...
        <div class="mr-auto" style="padding-top: 30px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/formats">Setting Master</a></li>
                <li class="breadcrumb-item active" aria-current="/formats">Master Format</li>
            </ol>
        </div>
		...
		<div class="container mb-5 mt-3">
                    <div class="col-lg-10">
                        <a class="btn btn-dark" href="/formats/create">Tambah</a>
            ...
            <table class="table table-striped table-bordered" id="mydatatable">
				...
				@foreach ($formats as $format)
                    <tr>
                        ...
                        <td><a href="">11</a></td>
                        <td> <div>
                            <a class="btn btn-dark" href='/formats/{{$format->id}}/edit'>Sunting</a>
